...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *viewB;
...
- (void)viewDidLoad {
    ...
    self.viewB.constant = L2C_TabbarSafeBottomMargin;
...
- (void)resetBottomBtnsStatus
{
    if (self.arraySelectPhotos.count > 0) {
        ...
        [self.btnOriginalPhoto setTitleColor:kRGB(0,122,255) forState:UIControlStateNormal];
        [self.btnPreView setTitleColor:kRGB(0,122,255) forState:UIControlStateNormal];
        [self.btnDone setBackgroundImage:[UIImage imageNamed:@"yj_icon_wanchengxuanzhong"] forState:(UIControlStateNormal)];
        ...
        [self.btnPreView setTitleColor:[UIColor colorWithWhite:0.7 alpha:1] forState:UIControlStateDisabled];
         [self.btnDone setBackgroundImage:[UIImage imageNamed:@"yj_icon_wanchengmeixuan"] forState:(UIControlStateNormal)];
