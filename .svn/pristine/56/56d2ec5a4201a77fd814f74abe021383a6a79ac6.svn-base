...
//    UIImage *normalImg = [UIImage imageNamed:@"yj_icon_yuantumeixuan"];
...
//    UIImage *selImg = [UIImage imageNamed:@"yj_icon_yuantuxuanzhong"];
...
//    _bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 44, kViewWidth, 44)];
    _bottomView = [[UIToolbar alloc] initWithFrame:CGRectMake(0, kViewHeight - 44 - L2C_TabbarSafeBottomMargin, kViewWidth, 44)];
    _bottomView.barStyle = UIBarStyleBlack;
//    toolBar.items
    NSMutableArray *items = @[].mutableCopy;
    
    
    _bottomView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:1/255.0 alpha:0.67];
    ...
    [_btnOriginalPhoto setTitleColor:[UIColor whiteColor] forState: UIControlStateSelected];
    UIImage *normalImg = [UIImage imageNamed:kZLPhotoBrowserSrcName(@"btn_circle.png")]?:[UIImage imageNamed:kZLPhotoBrowserFrameworkSrcName(@"btn_circle.png")];
//    UIImage *normalImg = [UIImage imageNamed:@"yj_icon_yuantumeixuan"];
    UIImage *selImg = [UIImage imageNamed:kZLPhotoBrowserSrcName(@"btn_selected.png")]?:[UIImage imageNamed:kZLPhotoBrowserFrameworkSrcName(@"btn_selected.png")];
//    UIImage *selImg = [UIImage imageNamed:@"yj_icon_yuantuxuanzhong"];
    ...
    [items addObject:[[UIBarButtonItem alloc] initWithCustomView:_btnOriginalPhoto]];
...
//    [_bottomView addSubview:_btnOriginalPhoto];
    ...
    self.labPhotosBytes.textColor = [UIColor whiteColor];
//    [_bottomView addSubview:self.labPhotosBytes];
    
    [items addObject:[[UIBarButtonItem alloc] initWithCustomView:self.labPhotosBytes]];
    ...
    [_btnDone setBackgroundColor:kRGB(0,122,255)];
...
//    [_bottomView addSubview:_btnDone];
    ...
    [items addObject:[[UIBarButtonItem alloc] initWithCustomView:_btnDone]];
    
    _bottomView.items = items;
...
- (void)changeBtnDoneTitle
{
    if (self.arraySelectPhotos.count > 0) {
        ...
        [_btnDone setBackgroundImage:[UIImage imageNamed:@"yj_icon_wanchengxuanzhong"] forState:(UIControlStateNormal)];
    } else {
        _btnDone.enabled = NO;
        [_btnDone setBackgroundImage:[UIImage imageNamed:@"yj_icon_wanchengmeixuan"] forState:(UIControlStateNormal)];
        [_btnDone setTitle:GetLocalLanguageTextValue(ZLPhotoBrowserDoneText) forState:UIControlStateNormal];
    }
}
...
- (void)showNavBarAndBottomView
{
    ...
    frame.origin.y -= frame.size.height + L2C_TabbarSafeBottomMargin;
